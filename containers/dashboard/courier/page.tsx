...
const CourierContainer = () => {
  ...
  const testRequest = async () =>
    await new Promise((res, rej) => {
      toast.promise(
        sendMessage(
          // 'Estimado usuario, Suc. Virtual Personas te informa que se activo un seguro de celular protegido por $139,900. El 05/08/2024. Si desea cancelar: t.ly/8GYVH TyC*',
          '{name} test',
          [],
